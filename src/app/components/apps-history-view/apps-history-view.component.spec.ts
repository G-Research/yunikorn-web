...
import { AppsHistoryViewComponent } from './apps-history-view.component';
import { SchedulerServiceLoader } from '@app/services/scheduler/scheduler-loader.service';

describe('AppsViewComponent', () => {
  let component: AppsHistoryViewComponent;
  let fixture: ComponentFixture<AppsHistoryViewComponent>;

  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [AppsHistoryViewComponent],
      imports: [
    ...
    fixture = TestBed.createComponent(AppsHistoryViewComponent);
